...
class CCommscomm : public CWnd
{
protected:
	DECLARE_DYNCREATE(CCommscomm)
public:
...
comEvEOF = 7
*/
#define COM_EVT_SEND		1
#define COM_EVT_RECEIVE		2
#define COM_EVT_CTS			3
#define COM_EVT_DSR			4
#define COM_EVT_CD			5
#define COM_EVT_RING		6
#define COM_EVT_EOF			7
